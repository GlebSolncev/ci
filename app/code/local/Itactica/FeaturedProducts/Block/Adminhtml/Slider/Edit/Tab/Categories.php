...
class Itactica_FeaturedProducts_Block_Adminhtml_Slider_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('itactica_featuredproducts/slider/edit/tab/categories.phtml');
     ...
     * Returns root node
     *
     * @param Itactica_FeaturedProducts_Model_Category|null $parentNodeCategory
