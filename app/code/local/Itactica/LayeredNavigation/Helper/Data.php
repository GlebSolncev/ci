...
class Itactica_LayeredNavigation_Helper_Data extends Mage_Core_Helper_Data
{
    /**
    ...
    {
        return Mage::getStoreConfig('itactica_layerednavigation/catalog/price_slider_delay');
    }
    ...
    {
        return (int) Mage::getStoreConfig('itactica_layerednavigation/catalog/price_slider_submit_type');
    }
    ...
    {
        return '/' . Mage::getStoreConfig('itactica_layerednavigation/catalog/routing_suffix');
    }
