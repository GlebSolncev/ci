...
class Itactica_TextBoxes_Block_Box_Widget_View extends Mage_Catalog_Block_Product_Abstract implements Mage_Widget_Block_Interface
{
    ...
    {
        $identifier = $this->getData('box_id');
        $cacheArray = array(
     ...
     * @var string
     */
    protected $_htmlTemplate = 'itactica_textboxes/box/widget/view.phtml';
