...
class Itactica_FeaturedCategories_Block_Adminhtml_Slider_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element){
        ...
        $sourceUrl = $this->getUrl('*/featuredcategories_slider_widget/chooser', array('uniq_id' => $uniqId));
        $chooser = $this->getLayout()->createBlock('widget/adminhtml_widget_chooser')
                ...
                ->setUniqId($uniqId);
        if ($element->getValue()) {
            $slider = Mage::getModel('itactica_featuredcategories/slider')->load($element->getValue());
            if ($slider->getId()) {
     ...
     * @access protected
     * @return Itactica_FeaturedCategories_Block_Adminhtml_Slider_Widget_Chooser
     */
    ...
    public function getGridUrl(){
        return $this->getUrl('adminhtml/featuredcategories_slider_widget/chooser', array('_current' => true));
    }
    /**
