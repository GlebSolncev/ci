...
class Itactica_FeaturedCategories_Model_Resource_Slider_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _renderFiltersBefore(){
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('itactica_featuredcategories/slider_store')),
    ...
    public function addCategoryFilter($category){
        ...
        if (!isset($this->_joinedFields['category'])){
            $this->getSelect()->join(
                array('related_category' => $this->getTable('itactica_featuredcategories/slider_category')),
