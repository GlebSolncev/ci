...
class Itactica_Intenso_Block_Adminhtml_Slider_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element){
        ...
        $sourceUrl = $this->getUrl('itactica_featuredproducts/adminhtml_featuredproducts_slider_widget/chooser', array('uniq_id' => $uniqId));
