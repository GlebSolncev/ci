...
class Itactica_Intenso_Model_Config_Fonts
{
     ...
     * @var array
     */
    public function fontSubset()
    {
        return array(
            array('value' => 'cyrillic',
                  'label' => Mage::helper('itactica_intenso')->__('Cyrillic')),

            array('value' => 'cyrillic-ext',
                  'label' => Mage::helper('itactica_intenso')->__('Cyrillic extended')),

            array('value' => 'greek',
                  'label' => Mage::helper('itactica_intenso')->__('Greek')),

            array('value' => 'greek-ext',
                  'label' => Mage::helper('itactica_intenso')->__('Greek Extended')),

            array('value' => 'khmer',
                  'label' => Mage::helper('itactica_intenso')->__('Khmer')),

            array('value' => 'latin',
                  'label' => Mage::helper('itactica_intenso')->__('Latin')),

            array('value' => 'latin-ext',
                  'label' => Mage::helper('itactica_intenso')->__('Latin Extended')),

            array('value' => 'vietnamese',
                  'label' => Mage::helper('itactica_intenso')->__('Vietnamese'))
    ...
    public function fontStyles()
    {
        return array(
            array('value' => '100',
                  'label' => Mage::helper('itactica_intenso')->__('Thin 100')),

            array('value' => '100italic',
                  'label' => Mage::helper('itactica_intenso')->__('Thin 100 Italic')),

            array('value' => '200',
                  'label' => Mage::helper('itactica_intenso')->__('Extra-Light 200')),

            array('value' => '200italic',
                  'label' => Mage::helper('itactica_intenso')->__('Extra-Light 200 Italic')),

            array('value' => '300',
                  'label' => Mage::helper('itactica_intenso')->__('Light 300')),

            array('value' => '300italic',
                  'label' => Mage::helper('itactica_intenso')->__('Light 300 Italic')),

            array('value' => '400',
                  'label' => Mage::helper('itactica_intenso')->__('Normal 400')),

            array('value' => '400italic',
                  'label' => Mage::helper('itactica_intenso')->__('Normal 400 Italic')),

            array('value' => '500',
                  'label' => Mage::helper('itactica_intenso')->__('Medium 500')),

            array('value' => '500italic',
                  'label' => Mage::helper('itactica_intenso')->__('Medium 500 Italic')),

            array('value' => '600',
                  'label' => Mage::helper('itactica_intenso')->__('Semi-Bold 600')),

            array('value' => '600italic',
                  'label' => Mage::helper('itactica_intenso')->__('Semi-Bold 600 Italic')),

            array('value' => '700',
                  'label' => Mage::helper('itactica_intenso')->__('Bold 700')),

            array('value' => '700italic',
                  'label' => Mage::helper('itactica_intenso')->__('Bold 700 Italic')),

            array('value' => '800',
                  'label' => Mage::helper('itactica_intenso')->__('Extra-Bold 800')),

            array('value' => '800italic',
                  'label' => Mage::helper('itactica_intenso')->__('Extra-Bold 800 Italic')),

            array('value' => '900',
                  'label' => Mage::helper('itactica_intenso')->__('Ulra-Bold 900')),

            array('value' => '900italic',
                  'label' => Mage::helper('itactica_intenso')->__('Ultra-Bold 900 Italic')),
        );
    }
