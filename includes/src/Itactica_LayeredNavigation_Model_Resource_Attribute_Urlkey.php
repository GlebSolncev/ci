...
class Itactica_LayeredNavigation_Model_Resource_Attribute_Urlkey extends Mage_Core_Model_Resource_Db_Abstract
{
     ...
     * @return Itactica_LayeredNavigation_Model_Resource_Attribute_Urlkey
     */
