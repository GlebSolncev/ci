...
abstract class Itactica_LogoSlider_Helper_Image_Abstract extends Mage_Core_Helper_Data
{
    /**
     ...
     * @return Itactica_LogoSlider_Helper_Image_Abstract
     */
   ...
   /**
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|Itactica_LogoSlider_Helper_Image_Abstract)
     */
