...
class Itactica_OrbitSlider_Model_Resource_Slides_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Itactica_OrbitSlider_Model_Resource_Slides_Collection
     */
    ...
    protected function _renderFiltersBefore(){
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('itactica_orbitslider/slides_store')),
                'main_table.entity_id = store_table.slide_id',
                array()
